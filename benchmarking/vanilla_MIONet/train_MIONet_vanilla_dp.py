...
#
# Description: vanilla_MIONet/train_MIONet_vanilla_dp.py
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train vanilla MIONet pressure buildup model")
...
def main():
    ...
    run_name = f"vanilla_mionet_dp_{time.strftime('%Y%m%d-%H%M%S')}"
    run_config = {
    ...
    checkpoint_prefix = os.path.join(save_dir, "MIONet_vanilla_dP")
