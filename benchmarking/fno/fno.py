...
class FNOBlock3d(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self._fourier_layer(x, self.conv3, self.w3)
        x = self._fourier_layer(x, self.conv4, self.w4)
        x = self._fourier_layer(x, self.conv5, self.w5)
...
class FNO3d(nn.Module):
    def __init__(self, modes1, modes2, modes3, width):
        super().__init__()
        self.block = FNOBlock3d(modes1, modes2, modes3, width)
