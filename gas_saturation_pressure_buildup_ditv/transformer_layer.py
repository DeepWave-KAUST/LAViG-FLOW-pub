###############################################################################
# Transformer Layer (Video Diffusion inspired) (2025)
#
# Author: Vittoria De Pellegrini
# Affiliation: PhD Student, King Abdullah University of Science and Technology
#
# Description:
#   Adapted from the Video Diffusion reference implementation:
#   https://github.com/explainingai-code/VideoGeneration-PyTorch
#   Implements per-layer adaptive normalization and residual attention/MLP blocks
#   used throughout the DiTV architecture.
###############################################################################
