###############################################################################
# Multi-Head Attention (Video Diffusion inspired) (2025)
#
# Author: Vittoria De Pellegrini
# Affiliation: PhD Student, King Abdullah University of Science and Technology
#
# Description:
#   Vanilla ViT-style attention block adapted from the Video Diffusion
#   reference implementation (https://github.com/explainingai-code/VideoGeneration-PyTorch).
#   Operates on [B, N, C] sequences and returns the same shape after projecting
#   across heads. Used inside every DiTV transformer layer.
###############################################################################
