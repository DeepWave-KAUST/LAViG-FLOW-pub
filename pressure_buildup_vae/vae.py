###############################################################################
# VAE architecture (2025)
#
# Author: Vittoria De Pellegrini
# Affiliation: PhD Student, King Abdullah University of Science and Technology
#
# Notes:
#   Adapted from the StableDiffusion-PyTorch VAE implementation:
#   https://github.com/explainingai-code/StableDiffusion-PyTorch/blob/main/models/vae.py
###############################################################################
...
# --------------------------------------------------
# Model: assemble hierarchical VAE autoencoder
# --------------------------------------------------
class VAE(nn.Module):
    def __init__(self, im_channels, autoencoder_model_config): 
        ...
        for i in range(len(self.down_channels) - 1):
            self.encoder_layers.append(VAE_DownBlock(self.down_channels[i], self.down_channels[i + 1],
        ...
        for i in range(len(self.mid_channels) - 1):
            self.encoder_mids.append(VAE_MidBlock(self.mid_channels[i], self.mid_channels[i + 1],
                                              t_emb_dim=None,
                                              num_heads=self.num_heads,
        ...
        # Pre Quantization Convolutional Layer
        ...
        # Post Quantization Convolution Convolutional Layer
        ...
        for i in reversed(range(1, len(self.mid_channels))):
            self.decoder_mids.append(VAE_MidBlock(self.mid_channels[i], self.mid_channels[i - 1],
                                              t_emb_dim=None,
                                              num_heads=self.num_heads,
                                              num_layers=self.num_mid_layers,
                                              norm_channels=self.norm_channels,
        ...
        for i in reversed(range(1, len(self.down_channels))):
            self.decoder_layers.append(VAE_UpBlock(self.down_channels[i], self.down_channels[i - 1],
